...
namespace Development.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,DepartmentId,Number,Title,Description")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,DepartmentId,Number,Title,Description")] Course course)
        {
            if (ModelState.IsValid)
            {
