...
namespace Development.Controllers.Administration
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var enrollment = db.Enrollment.Include(e => e.Course).Include(e => e.Semester).Include(e => e.Student);
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,CourseId,SemesterId")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentId,StudentId,CourseId,SemesterId")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
