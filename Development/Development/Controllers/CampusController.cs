...
namespace Development.Controllers
{
    public class CampusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,City,State,Zipcode")] Campus campus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,City,State,Zipcode")] Campus campus)
        {
            if (ModelState.IsValid)
            {
