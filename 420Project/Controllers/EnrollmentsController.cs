...
namespace _420Project.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,CourseId,SemesterId,Grade")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentId,StudentId,CourseId,SemesterId,Grade")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
