...
{
    public class AdminStudentCompliancesController : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: AdminStudentCompliances
        ...
        // GET: AdminStudentCompliances/Details/5
        ...
        // GET: AdminStudentCompliances/Create
        ...
        // POST: AdminStudentCompliances/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "SCId,ExpirationDate,SubmissionDate,ComplianceId,StudentId,Status")] StudentCompliance studentCompliance)
        {
        ...
        // GET: AdminStudentCompliances/Edit/5
        ...
        // POST: AdminStudentCompliances/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SCId,ExpirationDate,SubmissionDate,ComplianceId,StudentId,Status")] StudentCompliance studentCompliance)
        {
            if (ModelState.IsValid)
            {
        ...
        // GET: AdminStudentCompliances/Delete/5
        ...
        // POST: AdminStudentCompliances/Delete/5
